...
//		converters.add(marshallingHttpMessageConverter());
	 ...
	 * marshallingHttpMessageConverter() { MarshallingHttpMessageConverter converter
	 * = new MarshallingHttpMessageConverter();
	 * converter.setMarshaller(jaxb2Marshaller());
	 * converter.setUnmarshaller(jaxb2Marshaller()); return converter; }
	 */

	/*
	 * @Bean public Jaxb2Marshaller jaxb2Marshaller() { Jaxb2Marshaller marshaller =
	 * new Jaxb2Marshaller(); marshaller.setPackagesToScan(new String[] {
	 * "devfun.bookstore.common.domain", "devfun.bookstore.rest.domain",
